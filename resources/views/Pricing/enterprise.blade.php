...
<meta name="theme-color" content="#563d7c">
  ...
  <nav class="my-2 my-md-0 mr-md-3">
    <a class="p-2 text-dark" href="{{ url('/features') }}">Features</a>
    <a class="p-2 text-dark" href="<?= url('/enterprise'); ?>">Enterprise</a>
    <a class="p-2 text-dark" href="{{ url('/support') }}">Support</a>
    <a class="p-2 text-dark" href="<?php echo url('/pricing');?>">Pricing</a>
  </nav>
  <a class="btn btn-outline-primary" href="#">Sign up</a>
</div>

<div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
  <h1 class="display-4">Enterprise</h1>
  <p class="lead">
